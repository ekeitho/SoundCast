...
public class SoundCastDataSource {
    ...
    public SoundCastItem createCastItem(long id, String s_url, String a_url, String artist, String song, Timestamp first) {
        ...
        long insert_id = db.insertg(SoundCastSQLHelper.TABLE_NAME, null, values);
